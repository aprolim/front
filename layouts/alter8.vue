  ...
  <div class="min-h-screen">
    ...
    <header class="fixed top-0 inline-flex z-50 bg-transparent">
      ...
      <div class="h-14 bg-transparent inline-block items-center px-4">
        ...
        >
          <!-- Tamaños fijos por resolución -->
          <svg class="w-5 h-5          <!-- <640px: 20px -->
                sm:w-7 sm:h-7        <!-- 640px+: 28px -->
                md:w-8 md:h-8        <!-- 768px+: 32px -->
                lg:w-12 lg:h-12      <!-- 1024px+: 48px -->
                xl:w-14 xl:h-14      <!-- 1280px+: 56px -->
                2xl:w-16 2xl:h-16    <!-- 1536px+: 64px -->
                3xl:w-20 3xl:h-20    <!-- 1920px+: 80px -->
                4xl:w-32 4xl:h-32    <!-- 2560px+: 128px -->
                5xl:w-40 5xl:h-40    <!-- 3840px+: 160px -->
                text-white" 
    ...
    >
      ...
      <aside 
        :class="[
          ...
          // ANCHO RESPONSIVE - de 256px en móvil a 896px en 5K
          'w-64',                    // <480px: 256px
          'xs:w-72',                 // 480px+: 288px
          'sm:w-80',                 // 640px+: 320px
          'md:w-96',                 // 768px+: 384px
          'lg:w-[28rem]',            // 1024px+: 448px
          'xl:w-[32rem]',            // 1280px+: 512px
          '2xl:w-[36rem]',           // 1536px+: 576px
          '3xl:w-[40rem]',           // 1920px+: 640px
          '4xl:w-[48rem]',           // 2560px+: 768px
          '5xl:w-[56rem]',           // 3840px+: 896px
          // POSICIÓN SUPERIOR (top)
          'top-[34px]',                 // <480px: 34px
          'xs:top-[50px]',              // 480px+: 50px
          'sm:top-[44px]',              // 640px+: 44px
          'md:top-[47px]',              // 768px+: 47px
          'lg:top-[63px]',              // 1024px+: 63px
          'xl:top-[70px]',              // 1280px+: 70px
          '2xl:top-[80px]',             // 1536px+: 80px
          '3xl:top-[94px]',             // 1920px+: 94px
          '4xl:top-[145px]',             // 2560px+: 145px
          '5xl:top-[178px]',            // 3840px+: 178px
          
          // ALTURA DEL SIDEBAR
          'h-[calc(100vh-34px)]',        // <480px
          'xs:h-[calc(100vh-50px)]',     // 480px+
          'sm:h-[calc(100vh-44px)]',     // 640px+
          'md:h-[calc(100vh-47px)]',     // 768px+
          'lg:h-[calc(100vh-63px)]',     // 1024px+
          'xl:h-[calc(100vh-70px)]',     // 1280px+
          '2xl:h-[calc(100vh-80px)]',    // 1536px+
          '3xl:h-[calc(100vh-94px)]',    // 1920px+
          '4xl:h-[calc(100vh-145px)]',    // 2560px+
          '5xl:h-[calc(100vh-178px)]',   // 3840px+
          
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        ]"
      >
        <!-- Navegación principal - VERSIÓN COMPLETA CON TEXTOS RESPONSIVE -->
        <div class="p-4 overflow-y-auto h-[calc(100%-140px)]">
          ...
          <div class="mb-3">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="w-5 h-5 xs:w-6 xs:h-6 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 xl:w-9 xl:h-9 2xl:w-10 2xl:h-10 3xl:w-11 3xl:h-11 4xl:w-12 4xl:h-12 5xl:w-14 5xl:h-14">
                  <path d="M3 21h18M5 21V11h3V6h8v5h3v10M9 9h1m1.5 0h1m1.5 0h1M7 13h3m-3 2.5h3m-3 2.5h3m4-5h3m-3 2.5h3m-3 2.5h3M11 21v-3h2v3M12 6V2l4 1.5-4 1.5" 
                        stroke="white" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <!-- Texto principal responsive -->
                <span class="font-medium text-sm xs:text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl">La institución</span>
              </div>
              <!-- Flecha responsive -->
              <svg class="w-4 h-4 xs:w-5 xs:h-5 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-9 2xl:h-9 3xl:w-10 3xl:h-10 4xl:w-11 4xl:h-11 5xl:w-12 5xl:h-12 transition-transform duration-200"
            ...
            <div v-if="institutionOpen" class="ml-9 mt-2 mb-3 space-y-2 border-l border-gray-600/50 pl-3">
              <NuxtLink to="/alternative/constitucion/texto-completo" 
                        class="block py-2 px-3 rounded hover:bg-gray-700/30 transition-colors text-xs xs:text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl"
                        @click="sidebarOpen = false">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <g transform="translate(12, 12) scale(0.7)" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Texto principal responsive -->
                <span class="font-medium text-sm xs:text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl">Legisladores y representación</span>
              </div>
              <!-- Flecha responsive -->
              <svg class="w-4 h-4 xs:w-5 xs:h-5 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-9 2xl:h-9 3xl:w-10 3xl:h-10 4xl:w-11 4xl:h-11 5xl:w-12 5xl:h-12 transition-transform duration-200"
          ...
          <NuxtLink to="/alternative/participacion" 
                    ...
                    @click="sidebarOpen = false">
            <!-- Icono responsive -->
            <svg class="w-5 h-5 xs:w-6 xs:h-6 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 xl:w-9 xl:h-9 2xl:w-10 2xl:h-10 3xl:w-11 3xl:h-11 4xl:w-12 4xl:h-12 5xl:w-14 5xl:h-14" 
                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
            </svg>
            <!-- Texto responsive -->
            <span class="font-medium text-sm xs:text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl">Noticias</span>
          </NuxtLink>
          ...
          <div class="mb-3">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <!-- Texto principal responsive -->
                <span class="font-medium text-sm xs:text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl">Participación y transparencia</span>
              </div>
              <!-- Flecha responsive -->
              <svg class="w-4 h-4 xs:w-5 xs:h-5 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-9 2xl:h-9 3xl:w-10 3xl:h-10 4xl:w-11 4xl:h-11 5xl:w-12 5xl:h-12 transition-transform duration-200"
...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    svgIcon: '<svg class="w-full h-full text-white stroke-[#9CA3AF] stroke-[0.5px] group-hover:text-[#E03636] group-hover:stroke-transparent transition-all duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>',
    url: '#'
  },
  {
    name: 'TikTok',
    svgIcon: '<svg class="w-full h-full text-white stroke-[#9CA3AF] stroke-[0.5px] group-hover:text-[#E03636] group-hover:stroke-transparent transition-all duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>',
    url: '#'
  }
]
</script>
