<template>
  <div class="min-h-screen">
    ...
    <!-- Widget de Redes Sociales - ESCALA PROPORCIONAL OPTIMIZADA -->
      ...
      <div class="flex flex-col gap-[clamp(6px,1.2vh,16px)] items-end">
        <div class="flex flex-col gap-2 lg:gap-4 4xl:gap-8 items-end">
          <a v-for="(social, index) in socialLinks" :key="social.name"
            ...
            <!-- Tamaño optimizado para verse bien en TODAS las resoluciones -->
            <div v-html="social.svgIcon" 
                class="social-svg w-[clamp(10px,4vh,80px)] h-[clamp(10x,4vh,80px)] 4xl:w-[clamp(30px,5vh,80px)] 4xl:h-[clamp(30px,4.4vh,80px)] 5xl:w-[clamp(50px,5vh,180px)] 5xl:h-[clamp(50px,4.4vh,180px)]">
            </div>
          </a>
        </div>
      </div>
