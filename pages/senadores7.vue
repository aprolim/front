    ...
    <main class="main-content">
      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          <h3>🏛️ Distribución en Forma de U Doble - Hemiciclo del Senado</h3>
          <div class="hemicycle-info">
            <div class="info-item">
              <span>🎯 Fila 1 (U interna): 7 asientos izquierda | 7 asientos derecha</span>
              <span>🎯 Fila 2 (U externa): 11 asientos izquierda | 11 asientos derecha</span>
            </div>
          </div>
        </div>
        ...
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <!-- Fondo limpio (sin forma de U fea) -->
            <rect x="0" y="0" width="1200" height="800" fill="#ffffff"/>

            <!-- Línea divisoria del pasillo central -->
            <rect x="595" y="150" width="10" height="600" fill="url(#aisleGradient)" stroke="#94a3b8" stroke-width="1"/>
            <text x="600" y="140" text-anchor="middle" fill="#64748b" font-size="16" font-weight="600">
              🚫 PASILLO CENTRAL 🚫
            </text>
            <text x="600" y="160" text-anchor="middle" fill="#94a3b8" font-size="12">
              (Sin asientos - Separación)
            </text>

            <!-- Fila 1 - U Interna (14 asientos) -->
            <!-- Lado Izquierdo - 7 asientos (MAS) -->
            <g class="row-1-left">
              ...
              <!-- Etiqueta Fila 1 Izquierda -->
              <text x="150" y="320" text-anchor="start" fill="#3b82f6" font-size="14" font-weight="600">
                ↖️ Fila 1 (U Interna)
              </text>
              <text x="150" y="340" text-anchor="start" fill="#64748b" font-size="12">
                7 asientos - Lado Izquierdo
              </text>
            </g>

            <!-- Lado Derecho - 7 asientos (CC y Creemos) -->
            <g class="row-1-right">
              ...
              <!-- Etiqueta Fila 1 Derecha -->
              <text x="1050" y="320" text-anchor="end" fill="#3b82f6" font-size="14" font-weight="600">
                Fila 1 (U Interna) ↗️
              </text>
              <text x="1050" y="340" text-anchor="end" fill="#64748b" font-size="12">
                7 asientos - Lado Derecho
              </text>
            </g>

            <!-- Fila 2 - U Externa (22 asientos) -->
            <!-- Lado Izquierdo - 11 asientos (MAS) -->
            <g class="row-2-left">
              ...
              <!-- Etiqueta Fila 2 Izquierda -->
              <text x="150" y="620" text-anchor="start" fill="#dc2626" font-size="14" font-weight="600">
                ↙️ Fila 2 (U Externa)
              </text>
              <text x="150" y="640" text-anchor="start" fill="#64748b" font-size="12">
                11 asientos - Lado Izquierdo
              </text>
            </g>

            <!-- Lado Derecho - 11 asientos (CC y Creemos) -->
            <g class="row-2-right">
              ...
              <!-- Etiqueta Fila 2 Derecha -->
              <text x="1050" y="620" text-anchor="end" fill="#dc2626" font-size="14" font-weight="600">
                Fila 2 (U Externa) ↘️
              </text>
              <text x="1050" y="640" text-anchor="end" fill="#64748b" font-size="12">
                11 asientos - Lado Derecho
              </text>
            </g>

            <!-- Flecha indicando orientación -->
            <path d="M 600,100 L 600,130 M 600,100 L 590,115 M 600,100 L 610,115" 
              stroke="#3b82f6" stroke-width="3" fill="none"/>
            <text x="600" y="90" text-anchor="middle" fill="#1e40af" font-size="16" font-weight="700">
              ↑ PRESIDENCIA ↑
            </text>

            <!-- Líneas de separación estéticas -->
            <line x1="100" y1="380" x2="500" y2="380" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <line x1="700" y1="380" x2="1100" y2="380" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            
            <line x1="100" y1="550" x2="500" y2="550" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <line x1="700" y1="550" x2="1100" y2="550" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
          </svg>
          ...
          >
            ...
            <div class="tooltip-body">
              ...
              <div class="info-row">
                ...
                <span class="value">{{ hoveredSeat.row === 1 ? '1 (U Interna)' : '2 (U Externa)' }}</span>
              </div>
              <div class="info-row">
                <span class="label">Posición:</span>
                <span class="value">{{ hoveredSeat.side === 'left' ? 'Izquierda' : 'Derecha' }} del pasillo</span>
              </div>
      ...
      <div class="info-panel">
            ...
            <div class="photo-section">
              <div class="photo-container">
                ...
                <div class="senator-badges">
                  ...
                  <div class="badge seat-location" :style="{ 
                    backgroundColor: selectedSenator.row === 1 ? '#3b82f6' : '#dc2626',
                    color: 'white'
                  }">
                    Fila {{ selectedSenator.row }} ({{ selectedSenator.row === 1 ? 'U Interna' : 'U Externa' }})
                  </div>
                </div>
              </div>
              ...
              <div class="seat-info">
                <div class="info-card">
                  ...
                  <div class="card-content">
                    ...
                    <div class="card-label">Lado {{ selectedSenator.side === 'left' ? 'Izquierdo' : 'Derecho' }}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-else class="empty-state">
          ...
          <div class="empty-tips">
            <p><strong>🎯 Fila 1 (U Interna):</strong> 14 asientos (7 izquierda, 7 derecha)</p>
            <p><strong>🎯 Fila 2 (U Externa):</strong> 22 asientos (11 izquierda, 11 derecha)</p>
            <p><strong>🚫 Pasillo Central:</strong> Separación clara sin asientos</p>
          </div>
        </div>
      </div>
    </main>
...
// Datos de los 36 senadores con distribución clara
...
// Configuración de distribución clara y estética
const generateSeatPositions = () => {
  const centerX = 600  // Centro del SVG
  ...
  // Distribución clara y ordenada
  
  // FILA 1 - U INTERNA (más cerca de la presidencia)
  // 7 asientos izquierda - alineados verticalmente
  for (let i = 0; i < 7; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 1)
    if (senator) {
      const x = 150 + (i * 50)  // Distribuidos horizontalmente
      const y = 250  // Misma fila
  ...
  // 7 asientos derecha - alineados verticalmente
  for (let i = 0; i < 7; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 8)
    if (senator) {
      const x = 750 + (i * 50)  // Distribuidos horizontalmente
      const y = 250  // Misma fila
  ...
  // FILA 2 - U EXTERNA (más alejada)
  // 11 asientos izquierda - en arco suave
  for (let i = 0; i < 11; i++) {
    ...
    if (senator) {
      ...
      const y = 500 + Math.sin(angle) * radius * 0.5
  ...
  // 11 asientos derecha - en arco suave simétrico
  for (let i = 0; i < 11; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 26)
    if (senator) {
      // Arco simétrico al lado izquierdo
      const angle = Math.PI * 0.8 * (i / 10) + Math.PI * 0.4
      const radius = 150
...
const { row1LeftSeats, row1RightSeats, row2LeftSeats, row2RightSeats } = generateSeatPositions()

// Computados
const allSeats = computed(() => [...row1LeftSeats, ...row1RightSeats, ...row2LeftSeats, ...row2RightSeats])

// Métodos (se mantienen iguales con pequeños ajustes)
...
const getSeatColor = (seat) => {
  if (highlightedParty.value && seat.party !== highlightedParty.value) {
    return '#f3f4f6' // Gris muy claro para asientos no destacados
  }
...
/* Estilos específicos para las U */
.internal-u-indicator {
  pointer-events: none;
  opacity: 0.3;
}

.external-u-indicator {
  pointer-events: none;
  opacity: 0.3;
}
