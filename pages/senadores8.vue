    ...
    <header class="chamber-header">
      ...
      <div class="header-stats">
        ...
        <div class="stat">
          ...
          <div class="stat-label">Filas en Herradura</div>
        </div>
        <div class="stat">
    ...
    <main class="main-content">
      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          <h3>🏛️ Distribución en Forma de Herradura Doble - Hemiciclo del Senado</h3>
          <div class="hemicycle-info">
            <div class="info-item">
              <span>🎯 Fila 1: 14 asientos en herradura pequeña</span>
              <span>🎯 Fila 2: 22 asientos en herradura grande</span>
            </div>
          </div>
        </div>
        ...
        <!-- Hemiciclo SVG en forma de herradura doble -->
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <!-- Fila 1 - Herradura pequeña (14 asientos) -->
            <g class="row-1-horseshoe">
              <!-- Lado izquierdo - 7 asientos -->
              <g v-for="(seat, index) in row1LeftSeats" :key="seat.id">
                <circle
                  :cx="seat.x"
                  :cy="seat.y"
                  r="28"
              ...
              <!-- Lado derecho - 7 asientos -->
              <g v-for="(seat, index) in row1RightSeats" :key="seat.id">
                <circle
                  :cx="seat.x"
                  :cy="seat.y"
                  r="28"
              ...
              <!-- Etiqueta Fila 1 -->
              <text x="100" y="380" text-anchor="start" fill="#3b82f6" font-size="16" font-weight="600">
                🏛️ Fila 1 - Herradura Interna
              </text>
              <text x="100" y="400" text-anchor="start" fill="#64748b" font-size="14">
                14 asientos (7 izquierda + 7 derecha)
              </text>
            </g>

            <!-- Fila 2 - Herradura grande (22 asientos) -->
            <g class="row-2-horseshoe">
              <!-- Lado izquierdo - 11 asientos -->
              <g v-for="(seat, index) in row2LeftSeats" :key="seat.id">
                <circle
                  :cx="seat.x"
                  :cy="seat.y"
                  r="28"
              ...
              <!-- Lado derecho - 11 asientos -->
              <g v-for="(seat, index) in row2RightSeats" :key="seat.id">
                <circle
                  :cx="seat.x"
                  :cy="seat.y"
                  r="28"
              ...
              <!-- Etiqueta Fila 2 -->
              <text x="100" y="650" text-anchor="start" fill="#dc2626" font-size="16" font-weight="600">
                🏛️ Fila 2 - Herradura Externa
              </text>
              <text x="100" y="670" text-anchor="start" fill="#64748b" font-size="14">
                22 asientos (11 izquierda + 11 derecha)
              </text>
            </g>

            <!-- Líneas guía de forma de herradura -->
            <path d="M 300,250 Q 450,150 600,250" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <path d="M 300,250 L 200,350 L 180,500" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            
            <path d="M 900,250 Q 750,150 600,250" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <path d="M 900,250 L 1000,350 L 1020,500" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            
            <path d="M 200,550 Q 450,450 600,550" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <path d="M 200,550 L 150,400 L 130,600" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            
            <path d="M 1000,550 Q 750,450 600,550" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <path d="M 1000,550 L 1050,400 L 1070,600" fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
          ...
          >
            ...
            <div class="tooltip-body">
              ...
              <div class="info-row">
                <span class="label">Herradura:</span>
                <span class="value">{{ hoveredSeat.row === 1 ? 'Interna (Fila 1)' : 'Externa (Fila 2)' }}</span>
              </div>
              <div class="info-row">
      ...
      <div class="info-panel">
            ...
            <div class="photo-section">
              <div class="photo-container">
                ...
                <div class="senator-badges">
                  ...
                  <div class="badge horseshoe-location" :style="{ 
                    backgroundColor: selectedSenator.row === 1 ? '#3b82f6' : '#dc2626',
                    color: 'white'
                  }">
                    Herradura {{ selectedSenator.row === 1 ? 'Interna' : 'Externa' }}
                  </div>
                </div>
              </div>
              ...
              <div class="seat-info">
                <div class="info-card">
                  ...
                  <div class="card-content">
                    ...
                    <div class="card-label">Fila {{ selectedSenator.row }}, Lado {{ selectedSenator.side === 'left' ? 'Izquierdo' : 'Derecho' }}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-else class="empty-state">
          ...
          <div class="empty-tips">
            <p><strong>🏛️ Herradura Interna:</strong> 14 asientos (7 izquierda + 7 derecha)</p>
            <p><strong>🏛️ Herradura Externa:</strong> 22 asientos (11 izquierda + 11 derecha)</p>
...
// Datos de los 36 senadores
const senatorsData = ref([
  // Fila 1 - Herradura Interna (14 asientos)
  // Lado izquierdo: 7 asientos MAS (1-7)
  { id: 1, name: "María Eugenia Choque", seatNumber: 1, row: 1, side: 'left',
  ...
  { id: 13, name: "Marta Quispe", seatNumber: 13, row: 1, side: 'right',
    party: "Creemos", partyShort: "CRE", partyColor: "#f97316",
    department: "La Paz", initials: "MQ", age: 38,
    profession: "Médica", period: "2020-2025"
  },
  { id: 14, name: "Felipe Mendoza", seatNumber: 14, row: 1, side: 'right',
    party: "Creemos", partyShort: "CRE", partyColor: "#f97316",
    department: "Santa Cruz", initials: "FM", age: 42,
    profession: "Ingeniero", period: "2020-2025"
  },

  // Fila 2 - Herradura Externa (22 asientos)
  // Lado izquierdo: 11 asientos MAS (15-25)
  { id: 15, name: "Susana Méndez", seatNumber: 15, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Beni", initials: "SM", age: 44,
    profession: "Administradora", period: "2020-2025"
  },
  { id: 16, name: "Alberto Gutiérrez", seatNumber: 16, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Pando", initials: "AG", age: 56,
    profession: "Ingeniero", period: "2020-2025"
  },
  { id: 17, name: "Carmen Rosa Sánchez", seatNumber: 17, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "La Paz", initials: "CS", age: 49,
    profession: "Periodista", period: "2020-2025"
  },
  { id: 18, name: "Jorge Luis Pérez", seatNumber: 18, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Santa Cruz", initials: "JP", age: 51,
    profession: "Empresario", period: "2020-2025"
  },
  { id: 19, name: "Gabriela Torres", seatNumber: 19, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Cochabamba", initials: "GT", age: 46,
    profession: "Abogada", period: "2020-2025"
  },
  { id: 20, name: "Raúl Castro", seatNumber: 20, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Oruro", initials: "RC", age: 54,
    profession: "Sociólogo", period: "2020-2025"
  },
  { id: 21, name: "Elizabeth Ríos", seatNumber: 21, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Potosí", initials: "ER", age: 43,
    profession: "Educadora", period: "2020-2025"
  },
  { id: 22, name: "Mario Vargas", seatNumber: 22, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Tarija", initials: "MV", age: 52,
    profession: "Médico", period: "2020-2025"
  },
  { id: 23, name: "Silvia Fernández", seatNumber: 23, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Chuquisaca", initials: "SF", age: 48,
    profession: "Abogada", period: "2020-2025"
  },
  { id: 24, name: "Pedro Castillo", seatNumber: 24, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Beni", initials: "PC", age: 55,
    profession: "Ingeniero", period: "2020-2025"
  },
  { id: 25, name: "Claudia Paz", seatNumber: 25, row: 2, side: 'left',
    party: "MAS-IPSP", partyShort: "MAS", partyColor: "#dc2626",
    department: "Pando", initials: "CP", age: 44,
    profession: "Economista", period: "2020-2025"
  },
  
  // Lado derecho: 11 asientos CC + Creemos (26-36)
  { id: 26, name: "Victoria Choque", seatNumber: 26, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "La Paz", initials: "VC", age: 45,
    profession: "Abogada", period: "2020-2025"
  },
  { id: 27, name: "Walter Álvarez", seatNumber: 27, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Santa Cruz", initials: "WA", age: 52,
    profession: "Empresario", period: "2020-2025"
  },
  { id: 28, name: "Natalia Gutiérrez", seatNumber: 28, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Beni", initials: "NG", age: 46,
    profession: "Médica", period: "2020-2025"
  },
  { id: 29, name: "Óscar Paredes", seatNumber: 29, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Oruro", initials: "OP", age: 54,
    profession: "Abogado", period: "2020-2025"
  },
  { id: 30, name: "Rosa María López", seatNumber: 30, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Potosí", initials: "RL", age: 50,
    profession: "Educadora", period: "2020-2025"
  },
  { id: 31, name: "Héctor Vásquez", seatNumber: 31, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Pando", initials: "HV", age: 53,
    profession: "Ingeniero", period: "2020-2025"
  },
  { id: 32, name: "Karen Salazar", seatNumber: 32, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Tarija", initials: "KS", age: 44,
    profession: "Periodista", period: "2020-2025"
  },
  { id: 33, name: "Andrés Romero", seatNumber: 33, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "La Paz", initials: "AR", age: 50,
    profession: "Abogado", period: "2020-2025"
  },
  { id: 34, name: "Daniela Mendoza", seatNumber: 34, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Santa Cruz", initials: "DM", age: 47,
    profession: "Administradora", period: "2020-2025"
  },
  { id: 35, name: "Luis Fernando Arce", seatNumber: 35, row: 2, side: 'right',
    party: "Comunidad Ciudadana", partyShort: "CC", partyColor: "#2563eb",
    department: "Cochabamba", initials: "LA", age: 53,
    profession: "Economista", period: "2020-2025"
  },
  { id: 36, name: "Carolina Herrera", seatNumber: 36, row: 2, side: 'right',
    party: "Creemos", partyShort: "CRE", partyColor: "#f97316",
...
// Configuración de distribución en forma de herradura
const generateHorseshoePositions = () => {
  // Fila 1 - Herradura pequeña (14 asientos)
  const row1LeftSeats = []
  const row1RightSeats = []
  
  // Fila 2 - Herradura grande (22 asientos)
  const row2LeftSeats = []
  const row2RightSeats = []
  
  // Fila 1 - Herradura pequeña (más cerca de la presidencia)
  // Lado izquierdo - 7 asientos en forma de herradura
  const row1LeftPositions = [
    {x: 300, y: 250},  // Asiento superior izquierdo
    {x: 280, y: 300},
    {x: 260, y: 350},
    {x: 250, y: 400},
    {x: 260, y: 450},
    {x: 280, y: 500},
    {x: 300, y: 550}   // Asiento inferior izquierdo
  ]
  
  // Lado derecho - 7 asientos en forma de herradura (simétrica)
  const row1RightPositions = [
    {x: 900, y: 250},  // Asiento superior derecho
    {x: 920, y: 300},
    {x: 940, y: 350},
    {x: 950, y: 400},
    {x: 940, y: 450},
    {x: 920, y: 500},
    {x: 900, y: 550}   // Asiento inferior derecho
  ]
  
  // Asignar posiciones a senadores fila 1 izquierda
  for (let i = 0; i < 7; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 1)
    if (senator && row1LeftPositions[i]) {
      senator.x = row1LeftPositions[i].x
      senator.y = row1LeftPositions[i].y
      row1LeftSeats.push(senator)
    }
  }
  
  // Asignar posiciones a senadores fila 1 derecha
  for (let i = 0; i < 7; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 8)
    if (senator && row1RightPositions[i]) {
      senator.x = row1RightPositions[i].x
      senator.y = row1RightPositions[i].y
      row1RightSeats.push(senator)
    }
  }
  
  // Fila 2 - Herradura grande (más alejada)
  // Lado izquierdo - 11 asientos en forma de herradura más amplia
  const row2LeftPositions = [
    {x: 200, y: 200},  // Asiento más superior izquierdo
    {x: 180, y: 250},
    {x: 160, y: 300},
    {x: 150, y: 350},
    {x: 140, y: 400},
    ...
    {x: 200, y: 600},
    {x: 220, y: 650},
    {x: 240, y: 700}   // Asiento más inferior izquierdo
  ]
  
  // Lado derecho - 11 asientos en forma de herradura más amplia
  const row2RightPositions = [
    {x: 1000, y: 200},  // Asiento más superior derecho
    {x: 1020, y: 250},
    {x: 1040, y: 300},
    {x: 1050, y: 350},
    {x: 1060, y: 400},
    ...
    {x: 1000, y: 600},
    {x: 980, y: 650},
    {x: 960, y: 700}    // Asiento más inferior derecho
  ]
  
  // Asignar posiciones a senadores fila 2 izquierda
  for (let i = 0; i < 11; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 15)
    if (senator && row2LeftPositions[i]) {
      senator.x = row2LeftPositions[i].x
      senator.y = row2LeftPositions[i].y
      row2LeftSeats.push(senator)
    }
  }
  
  // Asignar posiciones a senadores fila 2 derecha
  for (let i = 0; i < 11; i++) {
    let senator = senatorsData.value.find(s => s.seatNumber === i + 26)
    if (senator && row2RightPositions[i]) {
      senator.x = row2RightPositions[i].x
      senator.y = row2RightPositions[i].y
      row2RightSeats.push(senator)
    }
  }
  
  return { row1LeftSeats, row1RightSeats, row2LeftSeats, row2RightSeats }
}

const { row1LeftSeats, row1RightSeats, row2LeftSeats, row2RightSeats } = generateHorseshoePositions()

// Computados
const allSeats = computed(() => [...row1LeftSeats, ...row1RightSeats, ...row2LeftSeats, ...row2RightSeats])
...
<style scoped>
/* Estilos completos (los mismos que proporcionaste anteriormente) */
.senate-chamber {
  min-height: 100vh;
