    ...
    <main class="main-content">
      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          <h3>🏛️ Distribución con Curvas Convexas hacia Arriba</h3>
        ...
        <!-- SVG con CURVAS CONVEXAS HACIA ARRIBA (CORREGIDO) -->
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <!-- CURVA SUPERIOR (14 círculos - convexa hacia arriba) -->
            ...
            <!-- CURVA INFERIOR (22 círculos - convexa hacia arriba) -->
            ...
            <!-- Líneas curvas guía CORREGIDAS (convexas hacia arriba) -->
            <!-- Curva Superior (forma de montaña) -->
            <path d="M 250,280 Q 600,320 950,280" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <text x="250" y="270" text-anchor="start" fill="#3b82f6" font-size="12">
              Curva Superior (14 senadores) - Extremos ↑ Centro ↓
            </text>
            
            <!-- Curva Inferior (forma de montaña más amplia) -->
            <path d="M 150,480 Q 600,530 1050,480" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <text x="150" y="470" text-anchor="start" fill="#dc2626" font-size="12">
              Curva Inferior (22 senadores) - Extremos ↑ Centro ↓
            </text>
...
// Configuración de POSICIONES con CURVAS CONVEXAS HACIA ARRIBA (CORRECTO)
const generateCurvedPositions = () => {
  ...
  // CURVA SUPERIOR CORREGIDA (convexa hacia arriba - extremos ARRIBA, centro ABAJO)
  // Lado izquierdo Curva Superior - 7 posiciones en curva convexa
  const upperLeftPositions = [
    {x: 250, y: 280},  // Extremo izquierdo: MÁS ARRIBA (1)
    {x: 300, y: 290},
    {x: 350, y: 300},
    {x: 400, y: 310},  // Centro: MÁS ABAJO (4)
    {x: 450, y: 300},
    {x: 500, y: 290},
    {x: 550, y: 280}   // Cerca del pasillo: MÁS ARRIBA (7)
  ]
  
  // Lado derecho Curva Superior - 7 posiciones en curva convexa
  const upperRightPositions = [
    {x: 650, y: 280},  // Cerca del pasillo: MÁS ARRIBA (8)
    {x: 700, y: 290},
    {x: 750, y: 300},
    {x: 800, y: 310},  // Centro: MÁS ABAJO (11)
    {x: 850, y: 300},
    {x: 900, y: 290},
    {x: 950, y: 280}   // Extremo derecho: MÁS ARRIBA (14)
  ]
  
  // CURVA INFERIOR CORREGIDA (convexa hacia arriba, más pronunciada)
  // Lado izquierdo Curva Inferior - 11 posiciones en curva más amplia
  const lowerLeftPositions = [
    {x: 150, y: 480},  // Extremo izquierdo: MÁS ARRIBA
    {x: 200, y: 490},
    {x: 250, y: 500},
    {x: 300, y: 510},
    {x: 350, y: 520},
    {x: 400, y: 530},  // Centro: MÁS ABAJO (posición 6 de 11)
    {x: 450, y: 520},
    {x: 500, y: 510},
    {x: 550, y: 500},
    {x: 600, y: 490},
    {x: 650, y: 480}   // Cerca del pasillo: MÁS ARRIBA
  ]
  
  // Lado derecho Curva Inferior - 11 posiciones en curva más amplia
  const lowerRightPositions = [
    {x: 550, y: 480},  // Cerca del pasillo: MÁS ARRIBA
    {x: 600, y: 490},
    {x: 650, y: 500},
    {x: 700, y: 510},
    {x: 750, y: 520},
    {x: 800, y: 530},  // Centro: MÁS ABAJO (posición 6 de 11)
    {x: 850, y: 520},
    {x: 900, y: 510},
    {x: 950, y: 500},
    {x: 1000, y: 490},
    {x: 1050, y: 480}  // Extremo derecho: MÁS ARRIBA
  ]
