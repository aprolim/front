    ...
    <main class="main-content">
      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          <h3>🏛️ Distribución con Curvas Cóncavas hacia Arriba</h3>
        ...
        <!-- SVG con CURVAS CÓNCAVAS HACIA ARRIBA -->
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <!-- CURVA SUPERIOR (14 círculos - cóncava hacia arriba) -->
            ...
            <!-- CURVA INFERIOR (22 círculos - cóncava hacia arriba) -->
            ...
            <!-- Líneas curvas guía CORREGIDAS (cóncavas hacia arriba) -->
            <!-- Curva Superior (arriba, más cerca de presidencia) -->
            <path d="M 250,350 Q 600,280 950,350" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <text x="250" y="340" text-anchor="start" fill="#3b82f6" font-size="12">
              Curva Superior (14 senadores)
            </text>
            
            <!-- Curva Inferior (abajo, más lejos de presidencia) -->
            <path d="M 150,550 Q 600,450 1050,550" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <text x="150" y="540" text-anchor="start" fill="#dc2626" font-size="12">
...
// Configuración de POSICIONES con CURVAS CÓNCAVAS HACIA ARRIBA
const generateCurvedPositions = () => {
  ...
  // CURVA SUPERIOR CORREGIDA (cóncava hacia arriba)
  // Lado izquierdo Curva Superior - 7 posiciones en curva cóncava hacia arriba
  const upperLeftPositions = [
    {x: 250, y: 350},  // Más a la izquierda, más alto
    {x: 300, y: 340},
    {x: 350, y: 335},
    {x: 400, y: 330},  // Punto más bajo de la curva (centro)
    {x: 450, y: 335},
    {x: 500, y: 340},
    {x: 550, y: 350}   // Cerca del pasillo, más alto
  ]
  
  // Lado derecho Curva Superior - 7 posiciones en curva cóncava hacia arriba
  const upperRightPositions = [
    {x: 650, y: 350},  // Cerca del pasillo, más alto
    {x: 700, y: 340},
    {x: 750, y: 335},
    {x: 800, y: 330},  // Punto más bajo de la curva (centro)
    {x: 850, y: 335},
    {x: 900, y: 340},
    {x: 950, y: 350}   // Más a la derecha, más alto
  ]
  
  // CURVA INFERIOR CORREGIDA (cóncava hacia arriba, más pronunciada)
  // Lado izquierdo Curva Inferior - 11 posiciones en curva más amplia
  const lowerLeftPositions = [
    {x: 150, y: 550},  // Más a la izquierda, más alto
    {x: 200, y: 540},
    {x: 250, y: 530},
    {x: 300, y: 525},
    {x: 350, y: 520},
    {x: 400, y: 515},  // Punto más bajo de la curva (centro)
    {x: 450, y: 520},
    {x: 500, y: 525},
    {x: 550, y: 530},
    {x: 600, y: 540},
    {x: 650, y: 550}   // Cerca del pasillo, más alto
  ]
  
  // Lado derecho Curva Inferior - 11 posiciones en curva más amplia
  const lowerRightPositions = [
    {x: 550, y: 550},  // Cerca del pasillo, más alto
    {x: 600, y: 540},
    {x: 650, y: 530},
    {x: 700, y: 525},
    {x: 750, y: 520},
    {x: 800, y: 515},  // Punto más bajo de la curva (centro)
    {x: 850, y: 520},
    {x: 900, y: 525},
    {x: 950, y: 530},
    {x: 1000, y: 540},
    {x: 1050, y: 550}  // Más a la derecha, más alto
  ]
