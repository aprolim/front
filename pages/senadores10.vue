    ...
    <main class="main-content">
      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          <h3>🏛️ Distribución Exacta con Curvas - Hemiciclo del Senado</h3>
        ...
        <!-- SVG con CURVAS EXACTAS como la imagen -->
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <!-- Líneas curvas guía (para visualizar la curvatura) -->
            <!-- Curva Superior -->
            <path d="M 250,280 Q 600,230 950,280" 
            ...
            <!-- Curva Inferior -->
            <path d="M 150,450 Q 600,380 1050,450" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <text x="150" y="440" text-anchor="start" fill="#dc2626" font-size="12">
...
// Configuración de POSICIONES con CURVAS EXACTAS
const generateCurvedPositions = () => {
  ...
  // CURVA SUPERIOR (arriba, menos curva)
  // Lado izquierdo Curva Superior - 7 posiciones en curva
  const upperLeftPositions = [
    {x: 250, y: 280},  // Más a la izquierda
    {x: 300, y: 270},
    {x: 350, y: 265},
    {x: 400, y: 260},  // Centro de la curva
    {x: 450, y: 265},
    {x: 500, y: 270},
    {x: 550, y: 280}   // Cerca del pasillo
  ]
  
  // Lado derecho Curva Superior - 7 posiciones en curva (simétrica)
  const upperRightPositions = [
    {x: 650, y: 280},  // Cerca del pasillo
    {x: 700, y: 270},
    {x: 750, y: 265},
    {x: 800, y: 260},  // Centro de la curva
    {x: 850, y: 265},
    {x: 900, y: 270},
    {x: 950, y: 280}   // Más a la derecha
  ]
  
  // CURVA INFERIOR (abajo, más curva pronunciada)
  // Lado izquierdo Curva Inferior - 11 posiciones en curva más amplia
  const lowerLeftPositions = [
    {x: 150, y: 450},  // Más a la izquierda
    {x: 200, y: 440},
    {x: 250, y: 430},
    {x: 300, y: 425},
    {x: 350, y: 420},
    {x: 400, y: 415},  // Centro de la curva
    {x: 450, y: 420},
    {x: 500, y: 425},
    {x: 550, y: 430},
    {x: 600, y: 440},
    {x: 650, y: 450}   // Cerca del pasillo
  ]
  
  // Lado derecho Curva Inferior - 11 posiciones en curva más amplia (simétrica)
  const lowerRightPositions = [
    {x: 550, y: 450},  // Cerca del pasillo
    {x: 600, y: 440},
    {x: 650, y: 430},
    {x: 700, y: 425},
    {x: 750, y: 420},
    {x: 800, y: 415},  // Centro de la curva
    {x: 850, y: 420},
    {x: 900, y: 425},
    {x: 950, y: 430},
    {x: 1000, y: 440},
    {x: 1050, y: 450}  // Más a la derecha
  ]
