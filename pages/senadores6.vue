      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          ...
          <div class="hemicycle-info">
            <div class="info-item">
              <span>🎯 U Interna: 14 asientos (más cerca de la presidencia)</span>
              <span>🎯 U Externa: 22 asientos (más alejada)</span>
            </div>
          </div>
        </div>
        ...
        <!-- Hemiciclo SVG con distribución en forma de U doble -->
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <defs>
              ...
              <!-- Patrón de pasillo -->
              <pattern id="aislePattern" patternUnits="userSpaceOnUse" width="20" height="20">
                <path d="M0,0 L20,20" stroke="#94a3b8" stroke-width="2" opacity="0.3"/>
                <path d="M20,0 L0,20" stroke="#94a3b8" stroke-width="2" opacity="0.3"/>
              </pattern>
            </defs>

            <!-- Forma de U doble del hemiciclo -->
            <path 
              d="M 200,650 
                 Q 200,500 350,400 
                 Q 500,350 650,400 
            ...
            <!-- Pasillo central SIN asientos -->
            <rect x="495" y="350" width="10" height="500" fill="url(#aislePattern)"/>
            <rect x="495" y="350" width="10" height="500" fill="none" stroke="#94a3b8" stroke-width="2" stroke-dasharray="5,5"/>
            <text x="500" y="700" text-anchor="middle" fill="#64748b" font-size="14" font-weight="600">
              PASILLO CENTRAL
            </text>
            <text x="500" y="720" text-anchor="middle" fill="#94a3b8" font-size="11">
              Sin asientos
            </text>

            <!-- U INTERNA - 14 asientos (más cerca de la presidencia) -->
            <g class="row-1">
              <g v-for="(seat, index) in internalUSeats" :key="seat.id">
                <!-- Círculo del senador -->
                <circle
                  :cx="seat.x"
                  :cy="seat.y"
                ...
                <circle
                  ...
                  class="internal-u-indicator"
                />
              </g>
            </g>

            <!-- U EXTERNA - 22 asientos (más alejada) -->
            <g class="row-2">
              <g v-for="(seat, index) in externalUSeats" :key="seat.id">
                <circle
                  :cx="seat.x"
                  :cy="seat.y"
                  r="22"
                ...
                <circle
                  ...
                  class="external-u-indicator"
                />
              </g>
            </g>

            <!-- Etiquetas de posición -->
            <text x="150" y="850" fill="#4b5563" font-size="16" font-weight="600">
              IZQUIERDA
            </text>
            <text x="850" y="850" fill="#4b5563" font-size="16" font-weight="600" text-anchor="end">
              DERECHA
            </text>
            ...
            <g class="u-labels">
              <!-- U Interna -->
              <path d="M 50,450 L 80,450 L 80,500 L 50,500" fill="none" stroke="#3b82f6" stroke-width="2"/>
              <text x="40" y="480" fill="#3b82f6" font-size="14" text-anchor="end" font-weight="600">
                U Interna
              </text>
              <text x="40" y="495" fill="#3b82f6" font-size="12" text-anchor="end">
                (14 asientos)
              </text>
              
              <!-- U Externa -->
              <path d="M 50,600 L 80,600 L 80,650 L 50,650" fill="none" stroke="#dc2626" stroke-width="2"/>
              <text x="40" y="630" fill="#dc2626" font-size="14" text-anchor="end" font-weight="600">
                U Externa
              </text>
              <text x="40" y="645" fill="#dc2626" font-size="12" text-anchor="end">
                (22 asientos)
              </text>
            </g>

            <!-- Líneas de orientación hacia la presidencia -->
            <g class="orientation-lines">
              <!-- Línea desde la presidencia hacia el pasillo -->
              <path d="M 500,300 L 500,350" stroke="#3b82f6" stroke-width="3" fill="none"/>
              
              <!-- Flechas indicando orientación -->
              <path d="M 500,300 L 500,320 M 500,300 L 490,315 M 500,300 L 510,315" 
                stroke="#3b82f6" stroke-width="3" fill="none"/>
              
              <text x="500" y="290" text-anchor="middle" fill="#3b82f6" font-size="16" font-weight="700">
                ↑ Presidencia
              </text>
              
              <!-- Líneas desde las U hacia la presidencia -->
              <path d="M 350,400 L 350,320 L 480,320" stroke="#94a3b8" stroke-width="1" stroke-dasharray="5,5" fill="none"/>
              <path d="M 650,400 L 650,320 L 520,320" stroke="#94a3b8" stroke-width="1" stroke-dasharray="5,5" fill="none"/>
            </g>

            <!-- Líneas divisorias para visualización -->
            <path d="M 200,500 Q 350,450 500,450 Q 650,450 800,500" 
              fill="none" stroke="#e2e8f0" stroke-width="3" stroke-dasharray="10,5"/>
              
            <path d="M 200,700 Q 350,750 500,750 Q 650,750 800,700" 
              fill="none" stroke="#e2e8f0" stroke-width="3" stroke-dasharray="10,5"/>
          </svg>
          ...
          >
            ...
            <div class="tooltip-body">
              ...
              <div class="info-row">
                ...
                <span class="value">U {{ hoveredSeat.row === 1 ? 'Interna' : 'Externa' }}</span>
              </div>
      ...
      <div class="info-panel">
            ...
            <div class="photo-section">
              <div class="photo-container">
                ...
                <div class="senator-badges">
                  ...
                  <div class="badge u-location" :style="{ 
                    backgroundColor: selectedSenator.row === 1 ? '#3b82f6' : '#dc2626',
                    color: 'white'
                  }">
                    {{ selectedSenator.row === 1 ? 'U Interna' : 'U Externa' }}
                  </div>
                </div>
              </div>
              ...
              <div class="seat-info">
                <div class="info-card">
                  ...
                  <div class="card-content">
                    ...
                    <div class="card-label">U {{ selectedSenator.row === 1 ? 'Interna' : 'Externa' }}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-else class="empty-state">
          ...
          <div class="empty-tips">
            <p><strong>🎯 U Interna:</strong> 14 asientos más cerca de la presidencia (azul)</p>
            <p><strong>🎯 U Externa:</strong> 22 asientos más alejados (rojo)</p>
            <p><strong>🚫 Pasillo Central:</strong> Separación sin asientos entre izquierda y derecha</p>
          </div>
        </div>
      </div>
    </main>
...
const senatorsData = ref([
  ...
  // U EXTERNA - 22 asientos (más alejada de la presidencia)
...
// Configuración de distribución en forma de U DOBLE
const generateSeatPositions = () => {
  const centerX = 500
  
  // Configuración de las U
  // U INTERNA: 14 asientos (7 izquierda, 7 derecha) - más cerca de la presidencia
  const internalURadius = 150
  const internalUY = 450  // Más arriba (más cerca de la presidencia)
  
  // U EXTERNA: 22 asientos (11 izquierda, 11 derecha) - más alejada
  const externalURadius = 300
  const externalUY = 650  // Más abajo (más lejos de la presidencia)
  
  const internalUSeats = []
  const externalUSeats = []
  
  // U INTERNA - 14 asientos
  for (let i = 0; i < 14; i++) {
    ...
    if (senator) {
      ...
      if (i < 7) {
        // Lado izquierdo del pasillo (asientos 1-7)
        // Distribución más concentrada en forma de U
        const progress = i / 6
        angle = Math.PI * (0.2 + progress * 0.6)  // 36° a 144°
      } else {
        // Lado derecho del pasillo (asientos 8-14)
        const progress = (i - 7) / 6
        angle = Math.PI * (1.8 + progress * 0.6)  // 324° a 216°
      }
      
      x = centerX + Math.cos(angle) * internalURadius
      y = internalUY + Math.sin(angle) * internalURadius * 0.4
      
      // Asegurar que no queden asientos en el pasillo central
      if (x > 490 && x < 510) {
        x = i < 7 ? 490 - 30 : 510 + 30
      }
      ...
      senator.x = x
      senator.y = y
      internalUSeats.push(senator)
    }
  }
  
  // U EXTERNA - 22 asientos
  for (let i = 0; i < 22; i++) {
    ...
    if (senator) {
      ...
      if (i < 11) {
        // Lado izquierdo del pasillo (asientos 15-25)
        const progress = i / 10
        angle = Math.PI * (0.1 + progress * 0.8)  // 18° a 162°
      } else {
        // Lado derecho del pasillo (asientos 26-36)
        const progress = (i - 11) / 10
        angle = Math.PI * (1.9 + progress * 0.8)  // 342° a 198°
      }
      
      x = centerX + Math.cos(angle) * externalURadius
      y = externalUY + Math.sin(angle) * externalURadius * 0.3
      
      // Asegurar que no queden asientos en el pasillo central
      if (x > 490 && x < 510) {
        x = i < 11 ? 490 - 50 : 510 + 50
      }
      
      senator.x = x
      senator.y = y
      externalUSeats.push(senator)
    }
  }
  
  // Ordenar por número de asiento
  internalUSeats.sort((a, b) => a.seatNumber - b.seatNumber)
  externalUSeats.sort((a, b) => a.seatNumber - b.seatNumber)
  
  return { internalUSeats, externalUSeats }
}

const { internalUSeats, externalUSeats } = generateSeatPositions()

// Computados
const allSeats = computed(() => [...internalUSeats, ...externalUSeats])
