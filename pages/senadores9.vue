    ...
    <header class="chamber-header">
      ...
      <div class="header-stats">
        ...
        <div class="stat">
          ...
          <div class="stat-label">Fila Superior</div>
        </div>
        <div class="stat">
          <div class="stat-number">22</div>
          <div class="stat-label">Fila Inferior</div>
        </div>
      </div>
    </header>
    ...
    <main class="main-content">
      ...
      <div class="hemicycle-container">
        <div class="hemicycle-header">
          <h3>🏛️ Distribución Exacta - Hemiciclo del Senado</h3>
          <div class="hemicycle-info">
            <div class="info-item">
              <span>🎯 Fila Superior: 14 senadores</span>
              <span>🎯 Fila Inferior: 22 senadores</span>
              <span>🎯 Total: 36 senadores</span>
            </div>
          </div>
        </div>
        ...
        <!-- SVG con distribución EXACTA: 14 arriba, 22 abajo -->
        <div class="hemicycle-svg-container">
          ...
          >
            ...
            <!-- LADO IZQUIERDO -->
            <!-- Fila Superior Izquierda (7 de 14) -->
            <g v-for="(seat, index) in upperLeftSeats" :key="seat.id">
              <circle
                :cx="seat.x"
                :cy="seat.y"
                r="30"
            ...
            <!-- Fila Inferior Izquierda (11 de 22) -->
            <g v-for="(seat, index) in lowerLeftSeats" :key="seat.id">
              <circle
                :cx="seat.x"
                :cy="seat.y"
                r="30"
            ...
            <!-- LADO DERECHO -->
            <!-- Fila Superior Derecha (7 de 14) -->
            <g v-for="(seat, index) in upperRightSeats" :key="seat.id">
              <circle
                :cx="seat.x"
                :cy="seat.y"
                r="30"
            ...
            <!-- Fila Inferior Derecha (11 de 22) -->
            <g v-for="(seat, index) in lowerRightSeats" :key="seat.id">
              <circle
                :cx="seat.x"
                :cy="seat.y"
                r="30"
            ...
            <!-- Líneas curvas guía (OPCIONAL) -->
            <path d="M 250,250 Q 450,200 650,250" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <path d="M 200,400 Q 450,350 700,400" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            
            <path d="M 550,250 Q 750,200 950,250" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
            <path d="M 500,400 Q 750,350 1000,400" 
              fill="none" stroke="#e5e7eb" stroke-width="2" stroke-dasharray="5,5"/>
          ...
          >
            ...
            <div class="tooltip-body">
              ...
              <div class="info-row">
                ...
                <span class="value">{{ hoveredSeat.row === 1 ? 'Superior' : 'Inferior' }}</span>
              </div>
              <div class="info-row">
      ...
      <div class="info-panel">
            ...
            <div class="photo-section">
              <div class="photo-container">
                ...
                <div class="senator-badges">
                  ...
                  <div class="badge row-location" :style="{ 
                    backgroundColor: selectedSenator.row === 1 ? '#3b82f6' : '#dc2626',
                    color: 'white'
                  }">
                    Fila {{ selectedSenator.row === 1 ? 'Superior' : 'Inferior' }}
                  </div>
                </div>
              </div>
        ...
        <div v-else class="empty-state">
          ...
          <div class="empty-tips">
            <p><strong>🏛️ Fila Superior:</strong> 14 senadores (7 izquierda + 7 derecha)</p>
            <p><strong>🏛️ Fila Inferior:</strong> 22 senadores (11 izquierda + 11 derecha)</p>
...
// Datos de los 36 senadores (14 superior, 22 inferior)
const senatorsData = ref([
  // Fila Superior: 14 senadores (1-14)
  // Lado izquierdo: 7 senadores (1-7)
  ...
  // Fila Inferior: 22 senadores (15-36)
  // Lado izquierdo: 11 senadores (15-25)
  ...
  // Lado derecho: 11 senadores (26-36)
...
// Configuración de distribución EXACTA: 14 arriba, 22 abajo
const generateExactPositions = () => {
  const upperLeftSeats = []  // 7 senadores
  const upperRightSeats = [] // 7 senadores
  const lowerLeftSeats = []  // 11 senadores
  const lowerRightSeats = [] // 11 senadores
  
  // Posiciones para fila superior (más arriba, menos curva)
  ...
  // Posiciones para fila inferior (más abajo, más curva)
  ...
  // Asignar posiciones a senadores fila superior izquierda
  for (let i = 0; i < 7; i++) {
    ...
    if (senator && upperLeftPositions[i]) {
      ...
      upperLeftSeats.push(senator)
    }
  }
  
  // Asignar posiciones a senadores fila superior derecha
  for (let i = 0; i < 7; i++) {
    ...
    if (senator && upperRightPositions[i]) {
      ...
      upperRightSeats.push(senator)
    }
  }
  
  // Asignar posiciones a senadores fila inferior izquierda
  for (let i = 0; i < 11; i++) {
    ...
    if (senator && lowerLeftPositions[i]) {
      ...
      lowerLeftSeats.push(senator)
    }
  }
  
  // Asignar posiciones a senadores fila inferior derecha
  for (let i = 0; i < 11; i++) {
    ...
    if (senator && lowerRightPositions[i]) {
      ...
      lowerRightSeats.push(senator)
    }
  }
  
  return { upperLeftSeats, upperRightSeats, lowerLeftSeats, lowerRightSeats }
}

const { upperLeftSeats, upperRightSeats, lowerLeftSeats, lowerRightSeats } = generateExactPositions()
...
<style scoped>
/* Todos los estilos CSS se mantienen exactamente iguales que en el primer código */
.senate-chamber {
  min-height: 100vh;
